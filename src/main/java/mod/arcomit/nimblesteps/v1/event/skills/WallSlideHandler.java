...
//	}
//
//	public static void startWallSliding(MovementStateContext state) {
//		state.setWallSliding(true);
//	}
//
//	public static void endWallSliding(MovementStateContext state) {
...
//	}
//
//	private static void updateWallSlideGracePeriod(MovementStateContext state) {
...
//	}
//
//	public static boolean canWallSlide(Player player, MovementStateContext state) {
