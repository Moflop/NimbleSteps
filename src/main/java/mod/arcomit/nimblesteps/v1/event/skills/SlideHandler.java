...
//	}
//
//	public static void useSlide(Player player, MovementStateContext state, float forwardImpulse, float leftImpulse) {
//		if (forwardImpulse >= 0) {
...
//	}
//
//	public static void cancelSlide(Player player, MovementStateContext state) {
//		state.setSlideDuration(0);
//		player.setForcedPose(null);
//	}
//
//	public static boolean canSlide(Player player, MovementStateContext state) {
