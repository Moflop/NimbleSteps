package mod.arcomit.nimblesteps.v1.network;
...
import mod.arcomit.nimblesteps.v1.network.serverbound.jump.ServerboundUseSwimmingJumpPacket;
import mod.arcomit.nimblesteps.v1.network.serverbound.jump.ServerboundSupportWallJumpPacket;
import mod.arcomit.nimblesteps.v1.network.serverbound.jump.ServerboundMountPacket;
import mod.arcomit.nimblesteps.v1.network.serverbound.jump.ServerboundWallJumpPacket;
import mod.arcomit.nimblesteps.v1.network.serverbound.roll.ServerboundSetLandingRollWindowPacket;
...
import mod.arcomit.nimblesteps.v1.network.serverbound.armhang.ServerboundSyncArmHangingDirectionPacket;
import mod.arcomit.nimblesteps.v1.network.serverbound.swimmingboost.ServerboundUseSwimmingBoostPacket;
import mod.arcomit.nimblesteps.v1.network.serverbound.wallclimb.ServerboundEndWallClimbPacket;
import mod.arcomit.nimblesteps.v1.network.serverbound.wallclimb.ServerboundStartWallClimbPacket;
import mod.arcomit.nimblesteps.v1.network.serverbound.wallrun.ServerboundClampWallRunDurationPacket;
import mod.arcomit.nimblesteps.v1.network.serverbound.wallrun.ServerboundEndWallRunPacket;
import mod.arcomit.nimblesteps.v1.network.serverbound.wallrun.ServerboundStartWallRunPacket;
import mod.arcomit.nimblesteps.v1.network.serverbound.wallslide.ServerboundUpdateWallSlideStatePacket;
