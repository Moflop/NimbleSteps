...
//	}
//
//	public static void startWallClimb(MovementStateContext state) {
//		state.setWallClimbDuration(ServerConfig.wallClimbDuration);
//		state.setHasWallClimbed(true);
//	}
//
//	public static void endWallClimb(MovementStateContext state) {
//		state.setWallClimbDuration(0);
//	}
//
//	private static void decrementWallClimbDuration(MovementStateContext state) {
...
//	 * 判断客户端是否满足开始爬墙的条件。
//	 */
//	private static boolean canStartWallClimb(LocalPlayer player, MovementStateContext state) {
...
//	 * 判断双端是否满足持续墙跑的条件。
//	 */
//	public static boolean canWallClimb(Player player, MovementStateContext state) {
