...
//import mod.arcomit.nimblesteps.network.serverbound.jump.ServerboundWallJumpPacket;
...
//			PacketDistributor.sendToServer(new ServerboundWallJumpPacket());
//		}
//	}
//
//	/**
...
//	 */
//	public static void performWallJump(Player player, MovementStateContext state) {
...
//	 * 更新玩家的最后墙跳方向状态。
//	 */
//	private static void updateWallJumpDirectionState(Player player, MovementStateContext state) {
...
//	 * 重置状态结束滑墙。
//	 */
//	private static void resetMovementStates(MovementStateContext state) {
...
//	 */
//	public static boolean canWallJump(Player player, MovementStateContext state) {
...
//	private static boolean canJumpFromArmHanging(Player player, MovementStateContext state) {
...
//
//	/** 检查墙跑/滑墙期间是否可以跳跃。 */
//	private static boolean canJumpDuringWallAction(List<Direction> walls, MovementStateContext state) {
...
//	private static boolean canJumpFromAir(Player player, List<Direction> walls, MovementStateContext state) {
//		Direction facing = player.getDirection();
//		int lastJumpDir = state.getLastWallJumpDirection();
//
//		return walls.stream()
