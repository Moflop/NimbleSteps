...
//	}
//
//	public static void startWallRun(MovementStateContext state) {
//		state.setWallRunDuration(ServerConfig.wallRunDuration);
//		state.setWallRunCount(state.getWallRunCount() + 1);
//	}
//
//	public static void endWallRun(MovementStateContext state) {
//		state.setWallRunDuration(0);
//	}
//
//	public static void clampWallRunDuration(MovementStateContext state) {
//		state.setWallRunDuration(
//			Math.min(state.getWallRunDuration(), WALL_RUN_GRACE_PERIOD));
//	}
//
//	private static void decrementWallRunDuration(MovementStateContext state) {
...
//	 * 判断客户端是否满足开始墙跑的条件。
//	 */
//	private static boolean canStartWallRun(LocalPlayer player, MovementStateContext state) {
...
//	 * 判断双端是否满足持续墙跑的条件。
//	 */
//	public static boolean canWallRun(Player player, MovementStateContext state) {
