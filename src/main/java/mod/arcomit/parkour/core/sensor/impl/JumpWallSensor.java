...
public class JumpWallSensor {
	...
	private static final TagKey<Block> IGNORED_BLOCKS_TAG = ParkourTags.Blocks.SCAFFOLDING_BLOCKS;
	...
	public static void updateCacheIfNeeded(CollisionCache collisionCache, Player player, Direction direction) {
		...
		if (positionInvalid) {
			...
			boxes.add(BoxUtils.calculateDirectionalCheckBox(player, direction,
				BOX_MIN_HEIGHT_RATIO, BOX_MAX_HEIGHT_RATIO, COLLISION_CHECK_DISTANCE));
