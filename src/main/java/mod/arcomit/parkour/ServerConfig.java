...
public class ServerConfig {
	...
	static {
		...
		WALL_RUN_MAX_COUNT = builder
			...
			.translation(ParkourMod.MODID + ".configuration.wall_movement_settings.wall_run_max_count")
		...
		WALL_JUMP_RESET_WALL_RUN = builder
			...
			.translation(ParkourMod.MODID + ".configuration.wall_movement_settings.wall_jump_reset_wall_run")
			.define("wallJumpResetWallRun", true);
		// 蹬墙跳重置爬墙
		WALL_JUMP_RESET_WALL_CLIMB = builder
			.comment("Wall jump resets wall climb (default: true)")
			.translation(ParkourMod.MODID + ".configuration.wall_movement_settings.wall_jump_reset_wall_climb")
		...
		SUPPORT_WALL_JUMP_RESET_WALL_CLIMB = builder
			...
			.translation(ParkourMod.MODID + ".configuration.wall_movement_settings.support_wall_jump_reset_wall_climb")
		...
		ENABLE_MOUNT = builder
			...
			.translation(ParkourMod.MODID + ".configuration.wall_movement_settings.enable_mount")
		...
		MOUNT_REQUIRED_SPACE_HEIGHT = builder
			...
			.translation(ParkourMod.MODID + ".configuration.wall_movement_settings.mount_required_space_height")
		...
		// 爬墙持续时间(20*0.2=4,20tick[1秒]确保能爬上4格)
		...
		WALL_CLIMB_SPEED = builder
			...
			.defineInRange("wallClimb	Speed", 0.2, 0.05, 1.0);
