...
//import mod.arcomit.parkour.v2.core.sensor.impl.ArmhangGripSensor;
//import mod.arcomit.parkour.v2.core.sensor.impl.ArmhangSupportSensor;
...
//		boolean eyeGrip = ArmhangGripSensor.check(player, direction, true).colliding();
//		boolean eyeSupport = ArmhangSupportSensor.check(player, direction, true).colliding();
//
//		boolean topGrip = ArmhangGripSensor.check(player, direction, false).colliding();
//		boolean topSupport = ArmhangSupportSensor.check(player, direction, false).colliding();
//
...
//		boolean isFalling = player.fallDistance > b $RE0f;
//
