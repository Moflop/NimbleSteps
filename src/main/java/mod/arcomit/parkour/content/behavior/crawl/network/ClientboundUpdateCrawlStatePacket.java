package mod.arcomit.parkour.content.behavior.crawl.network;
...
public record ClientboundUpdateCrawlStatePacket(int entityId, boolean crawlState) implements CustomPacketPayload {
	public static final Type<ClientboundUpdateCrawlStatePacket> TYPE = new Type<>(ParkourMod.prefix("client_crawl"));
