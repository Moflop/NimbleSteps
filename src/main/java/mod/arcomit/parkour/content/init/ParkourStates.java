...
import mod.arcomit.parkour.content.behavior.mount.MountState;
...
public class ParkourStates {
	private static final DeferredRegister<IParkourState> PARKOUR_STATES = DeferredRegister.create(ParkourRegistries.PARKOUR_STATE_REGISTRY, ParkourMod.MODID);
