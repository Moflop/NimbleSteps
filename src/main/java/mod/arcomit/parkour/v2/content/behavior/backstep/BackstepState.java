...
import mod.arcomit.parkour.v2.content.behavior.backstep.client.ClientBackstepLogic;
...
public class BackstepState extends AbstractParkourState {
	...
	public void onClientEnter(Player player, ParkourContext context) {
		ClientBackstepLogic.playSound(player);
		if (player.isLocalPlayer()) {
			ClientBackstepLogic.applyPhysicsAndSendPosition(player);
		}
	}
