...
//
//	public static void startWallSliding(WallData wallData) {
//		wallData.setWallSliding(true);
//	}
//
//	public static void endWallSliding(WallData wallData) {
//		wallData.setWallSliding(false);
//		wallData.setWallSlideJumpReleaseGraceTicks(0);
//	}
//
//	public static void useWallSlideMovement(Player player, ParkourContext state) {
...
//	}
//
//	public static void updateWallSlideGracePeriod(WallData wallData) {
...
//	}
//
//	public static boolean canStartWallSlide(Player player, ParkourContext state) {
...
//	}
//
//	public static boolean isValid(Player player, ParkourContext state) {
...
//			&& state.groundData().getSlideDuration() <= 0
//			&& !state.wallData().isWallRunning()
//			&& !state.wallData().isWallClimbing()
//			&& !player.onClimbable()
//			&& !player.isInWater()
//			&& !player.isInLava()
...
//	 */
//	private static Direction findAvailableWallDirection(Player player, ParkourContext state) {
//		SensorManager sensorManager = SensorManager.get(player);
//		ArrayList<Direction> collisionDirections = new ArrayList<>(4);
//
//		for (Direction dir : Direction.Plane.HORIZONTAL) {
//			AbstractBoxSensor headSensor = sensorManager.getSensor("wall_head_" + dir.getName());
//			AbstractBoxSensor feetSensor = sensorManager.getSensor("wall_feet_" + dir.getName());
//
