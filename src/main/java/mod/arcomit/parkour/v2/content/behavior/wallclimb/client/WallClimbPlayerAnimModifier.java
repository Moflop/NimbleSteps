package mod.arcomit.parkour.v2.content.behavior.wallclimb.client;
...
@OnlyIn(Dist.CLIENT)
public class WallClimbPlayerAnimModifier extends AbstractModifier {
	...
	public void tick(AnimationData state) {
		...
		if (dy > 0.01 || dy < -0.01) {
			float currentWallClimbSpeed = ParkourConfig.WALL_CLIMB_SPEED.get().floatValue();
