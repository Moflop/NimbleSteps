...
//						.executes(context -> {
//							SensorDebugRenderHandler.DEBUG_TYPE = DebugType.WALL_SLIDE;
...
//						.executes(context -> {
//							SensorDebugRenderHandler.DEBUG_TYPE = DebugType.WALL_RUN;
...
//						.executes(context -> {
//							SensorDebugRenderHandler.DEBUG_TYPE = DebugType.WALL_CLIMB;
...
//						.executes(context -> {
//							SensorDebugRenderHandler.DEBUG_TYPE = DebugType.WALL_JUMP;
...
//						.executes(context -> {
//							SensorDebugRenderHandler.DEBUG_TYPE = DebugType.NONE;
