...
// * @author Arcomit
// */
//public final class HeadWallSensor {
...
//		SensorKey key = new SensorKey(SensorCategory.HEAD_WALL, direction);
//		return SensorCache.getOrCompute(player, key, () -> {
//			AABB box = calculateWorldBox(player, direction);
//			boolean colliding = CollisionUtils.isBlockCollision(player.level(), box, ParkourTags.Blocks.COMMON_IGNORED_BLOCKS);
...
//			pos.x - halfWidth,
//			pos.y + height * HEAD_BOX_MIN_HEIGHT_RATIO,
//			pos.z - halfWidth,
//			pos.x + halfWidth,
//			pos.y + height,
//			pos.z + halfWidth
