 ...
 * @author Arcomit
 */
public class FeetWallSensor extends AbstractBoxSensor {
	...
	public FeetWallSensor(Direction direction) {
		super("feet_wall_" + direction.getName());
	...
	protected boolean checkCollision(Player player, AABB box) {
		return CollisionUtils.isBlockCollision(player.level(), box, ParkourTags.Blocks.COMMON_IGNORED_BLOCKS);
	}
