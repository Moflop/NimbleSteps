package mod.arcomit.parkour.client;

import mod.arcomit.parkour.ParkourMod;
import mod.arcomit.parkour.v2.content.behavior.wallclimb.client.WallClimbPlayerAnimModifier;
import mod.arcomit.parkour.v2.content.behavior.wallrun.client.WallRunPlayerAnimModifier;
import mod.arcomit.parkour.v2.content.init.ParkourStates;
import mod.arcomit.parkour.v2.content.init.ParkourPlayerAnimations;
import mod.arcomit.parkour.v2.core.client.animation.camera.CameraAnimationRegistry;
import mod.arcomit.parkour.v2.content.behavior.landingroll.client.LandingRollPlayerAnimModifier;
import mod.arcomit.parkour.v2.content.behavior.slide.client.SlidePlayerAnimModifier;
import mod.arcomit.parkour.v2.core.client.animation.player.ClientAnimationRegistry;
import mod.arcomit.parkour.v2.content.behavior.wallslide.client.WallSlidePlayerAnimModifier;
import mod.arcomit.parkour.v2.core.proxy.client.*;
